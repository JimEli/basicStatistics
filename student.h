...
double dt(double x, unsigned int n) 
{
    assert(n >= 1);
...
double pt(double x, unsigned int n) 
{
    assert(n >= 1);
...
double qt(double p, unsigned int n) 
{
    assert(p >= 0 && p <= 1);
    assert(n >= 1);
